...
<script type="text/javascript" src="js/rno_2g_eri_cell_manage.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > 小区数据管理 > 爱立信2G小区数据管理</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">小区数据导入</a></li>
			<li><a href="#tabs-2">导入记录查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
							...
							<table>
								<tr>
									...
									<td><select id="dateType"
										name="">
											<option value='2GERICELLFILE'>小区数据</option>
											<option value='2GERICELLENGINFILE'>工参数据</option>
									</select></td>
					...
					<div id="importDiv" class="importContent">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<%-- input type="hidden" name="fileCode" id='fileCode'value="2GERICELLFILE" /--%> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">文件<span class="txt-impt">*</span>
											</td>
										...
										<tr>
											...
											<td style="width: 50%;" colspan="0">小区数据<input type="radio" id="cellData" name="fileCode" value="2GERICELLFILE" checked="checked" />　工参数据<input type="radio" id="enginData" name="fileCode" value="2GERICELLENGINFILE" /></td>
										</tr>
									</tbody>
			...
			<form id="searchNcsForm">
				...
				<table>
					<tr>
						...
						<td>
							 <select id="" name="attachParams['dataType']">
									<option value="ALL">全部</option>
									<option value="CELLDATA">小区数据</option>
									<option value="ENGINDATA">工参数据</option>
							</select>
							</td>
						<td style="padding-left:10px">测试时间 从:</td>
						<td><input type="text" value="" id="cellMeaBegDate"
							name="attachParams['cellMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="cellMeaEndDate" name="attachParams['cellMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchNcsBtn" value="查询导入记录"></input></td>
					</tr>
				</table>
			...
			<div id="ncsListDiv" class="sectionDivCls">
				...
				<div class="paging_div" id="ncsListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryCellDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryCellDescData,'searchNcsForm','ncsListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryCellDescData,'searchNcsForm','ncsListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryCellDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryCellDescData,'searchNcsForm','ncsListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
