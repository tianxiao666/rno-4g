...
<script type="text/javascript" src="js/rno_res_4g_kpi.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：KPI指标查询> KPI数据管理</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">KPI数据导入</a></li>
			<li><a href="#tabs-2">KPI数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4KPIFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMr" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="G4KPIFILE" /> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">KPI测量文件<span class="txt-impt">*</span>
											</td>
			...
			<form id="searchMrForm">
				...
				<table>
					<tr>
						...
						<td><input type="text" value="" id="kpiMeaBegDate"
							name="attachParams['kpiMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="kpiMeaEndDate" name="attachParams['kpiMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchMrBtn" value="查询KPI"></input></td>
					</tr>
				</table>
