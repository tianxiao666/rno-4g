					...
					<div class="resource_list300_box" style="height:100%;">
						...
						<div class="divtab_content" style="overflow-y:auto; overflow-x:auto; width:360px; height:600px">
							<div id="div_tab_0">
								...
								<br/>(默认值0.2，输入数字且k大于0小于0.5  限制图2)
								<div style="margin: 3px"></div>
								折线图形大小系数&nbsp;<input type="text" id="imgSizeCoeff" value="10"/> 
							...
							<div id="div_tab_1" style="display: none;">
								...
								<table class="main-table1" id="interDetailTab"  width="100%" height="400px" style="text-align:center;" border="1px" cellspacing="1px">
									<thead>
									<tr>
