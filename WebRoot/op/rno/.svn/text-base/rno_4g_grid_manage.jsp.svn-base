...
<script type="text/javascript" src="js/rno_4g_grid_manage.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：场景管理 > 网格数据管理 </h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">网格数据导入</a></li>
			<li><a href="#tabs-2">网格数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTEGRIDFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportNcs" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTEGRIDFILE" /> <input type="hidden" name="token"
								id="token" value="" />
								...
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr style="display:none">
											<td class="menuTd">导入日期<span class="txt-impt">*</span>
										...
										<tr>
											<td class="menuTd">网格文件<span class="txt-impt">*</span>
											</td>
			...
			<form id="searchNcsForm">
				...
				<table>
					<tr>
						...
						<td  style="padding-left:10px"><input type="button" id="searchNcsBtn" value="查询网格"></input></td>
					</tr>
				</table>

			</form>
			<div id="ncsListDiv" class="sectionDivCls">
				<table id="ncsListTab" class="greystyle-standard"
					style="width:auto;margin-left:0">
					<thead>
						<th>地市</th>
						<th>网格序列</th>
				...
				<div class="paging_div" id="ncsListPageDiv"
					...
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						...
						onclick="showListViewByPage('first',queryNcsDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryNcsDescData,'searchNcsForm','ncsListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryNcsDescData,'searchNcsForm','ncsListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryNcsDescData,'searchNcsForm','ncsListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryNcsDescData,'searchNcsForm','ncsListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
