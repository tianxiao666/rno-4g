...
<%-- 	<link rel="stylesheet" type="text/css" href="css/TableLock.css"> --%>
	...
	<script type="text/javascript" src="js/rno_4g_time_scene_manage.js?v=<%=(String)session.getAttribute("version")%>"></script>
...
<h2><span class='navTitle'>当前位置：场景管理 &gt; 时间场景管理 </span></h2>
	<center>
	  	 <font style="font-weight: bold;font-size:16px">时间场景信息</font> <br>
  	</center>
