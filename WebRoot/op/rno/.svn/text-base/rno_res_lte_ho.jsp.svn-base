...
<script type="text/javascript" src="js/rno_res_lte_ho.js"></script>
<script
...
<div style="margin: 50px;padding:10px">
	<h2><span class='navTitle'>当前位置：PCI优化 &gt; HO切换数据管理</span></h2>
	...
	<div id="tabs" >
		<ul>
			<li><a href="#tabs-1">切换数据导入</a></li>
			<li><a href="#tabs-2">切换数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
			<div>
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="LTE_ERI_HO_FILE" /> <input type="hidden"
						...
						<form id="formImport" enctype="multipart/form-data"
							...
							<input type="hidden" id="uploadCityId" name="cityId" value=""/>
								<table class="main-table1 half-width"	style="margin-left:0;width:50%">
									<tbody>
										<tr>
											<td class="menuTd">测量日期<span class="txt-impt">*</span>
										...
										<tr>
											<td class="menuTd">LTE切换数据文件<span class="txt-impt">*</span>
											</td>
										...
										<tr>
											<td class="menuTd">厂家<span class="txt-impt">*</span>
											</td>
											<td style="width: 50%; font-weight: bold" colspan="0">
											<select id="factory"
										name="">
											<option value='LTE_ZTE_HO_FILE'>中兴</option>
											<option value='LTE_ERI_HO_FILE'>爱立信</option>
											</select>
												</td>
										</tr>
									</tbody>
								</table>
							<div class="container-bottom" style="margin-left:0;padding-top: 10px;padding-bottom: 0px;width: 50%;">
								<table style="width: 60%; margin: auto" align="center">
									<tr>
										<td align="center" ><input type="button" value="导    入"	style="width: 90px;" id="importBtn" name="import" /> <br/>
											<div id="uploadMsgDiv" style="display:none"></div>	</td>
									</tr>
								</table>
								<div id="importResultDiv" class="container-bottom"
									style="padding-top:10px;margin:0px;padding-bottom: 0px;">
				...
				<div id="importListDiv" class="sectionDivCls">
					...
					<div class="paging_div" id="hoImportRecPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryImportDataRec,'searchImportForm','hoImportRecPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryImportDataRec,'searchImportForm','hoImportRecPageDiv')"></a>
						...
						<a class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryImportDataRec,'searchImportForm','hoImportRecPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryImportDataRec,'searchImportForm','hoImportRecPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryImportDataRec,'searchImportForm','hoImportRecPageDiv')"></a>
					</div>
				</div>
			</div>
			<%--某项job的报告 --%>
				...
				<table>
					<tr>
						...
						<td><select id="factory"
										name="attachParams['factory']">
											<option value='ALL'>全部</option>
											<option value='ZTE'>中兴</option>
											<option value='ERI'>爱立信</option>
											</select></td>
						<td style="padding-left:10px">测量时间 从:</td>
						<td><input type="text" value="" id="hoMeaBegDate"
							name="attachParams['hoMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="hoMeaEndDate" name="attachParams['hoMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchHoBtn" value="查询"></input></td>
					</tr>
				</table>

			</form>
			<div id="hoListDiv" class="sectionDivCls">
				<table id="hoListTab" class="greystyle-standard"
					style="width:auto;margin-left:0">
					<thead>
					<tr>
						<th>地市</th>
				...
				<div class="paging_div" id="hoListPageDiv"
					style="border: 1px solid #ddd">
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						条记录
					</span> <a class="paging_link page-first" title="首页"
						onclick="showListViewByPage('first',queryHoDescData,'searchHoForm','hoListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryHoDescData,'searchHoForm','hoListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryHoDescData,'searchHoForm','hoListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryHoDescData,'searchHoForm','hoListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryHoDescData,'searchHoForm','hoListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
