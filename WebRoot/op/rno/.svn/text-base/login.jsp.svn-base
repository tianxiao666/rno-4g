...
<%
	...
	String url = basePath+"op/rno/rnoUserIndexAction.action";
 %>
...
<link type="text/css"  rel="stylesheet" href="login/css/login.css?v=<%=(String)session.getAttribute("version")%>"/>
...
<body>
	...
	<div class="login_main">
		<div class="login_inner clearfix">
			...
			<%-- <div class="version_number"><em><%=(String)session.getAttribute("version")%></em></div> --%>
			...
			<div class="login_block">
				...
				<div class="login_form">
					<form:form method="post"  id="loginForm" cssClass="fm-v clearfix"  action="rnoAuthenticate.action"  htmlEscape="true">
						<%
						   String userNameInfo="";
						   String passwordInfo="";
						...
						<div class="loginFormIptWiotTh">
							<button type="submit" class="btn btn_login" onclick="permission();">登&nbsp;录</button>
						</div>
	...
	<div class="login_footer">
		<div class="footer_inner">
			...
			<div class="footer_nav">
				...
				<a href="#">客户服务</a>
				<a href="#">隐私政策</a>
				<a href="fileDownloadAction?fileName=rno4g_user_manual.zip" target="_blank">使用说明书下载</a>
				|<span class="copyright"><%=(String)session.getAttribute("projectName")+" "+(String)session.getAttribute("version")%></span>
				<span class="copyright">广东怡创科技股份有限公司版权所有 &copy; 2013-2015</span>
			</div>
		</div>
	</div>
	<%
