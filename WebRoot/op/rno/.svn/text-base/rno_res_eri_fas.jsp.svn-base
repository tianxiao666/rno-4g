...
<script type="text/javascript" src="js/rno_res_eri_fas.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：资源管理 > FAS数据管理 > 爱立信FAS数据管理</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">爱立信FAS数据导入</a></li>
			<li><a href="#tabs-2">爱立信FAS数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="ERICSSONFASFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportFas" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
								value="ERICSSONFASFILE" /> <input type="hidden" name="token"
								id="token" value="" />
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">FAS测量文件<span class="txt-impt">*</span>
											</td>
				...
				<div id="importListDiv" class="sectionDivCls">
					...
					<div class="paging_div" id="fasImportRecPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryImportDataRec,'searchImportForm','fasImportRecPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryImportDataRec,'searchImportForm','fasImportRecPageDiv')"></a>
						...
						<a class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryImportDataRec,'searchImportForm','fasImportRecPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryImportDataRec,'searchImportForm','fasImportRecPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryImportDataRec,'searchImportForm','fasImportRecPageDiv')"></a>
					</div>
				</div>
			</div>
			<%--某项job的报告 --%>
				...
				<table>
					<tr>
						...
						<td><input type="text" value="" id=""
							name="attachParams['bsc']" /></td>
						<td style="padding-left:10px">测试时间 从:</td>
						<td><input type="text" value="" id="fasMeaBegDate"
							name="attachParams['fasMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="fasMeaEndDate" name="attachParams['fasMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchFasBtn" value="查询FAS"></input></td>
					</tr>
				</table>

			</form>
			<div id="fasListDiv" class="sectionDivCls">
				<table id="fasListTab" class="greystyle-standard"
					style="width:auto;margin-left:0">
					<thead>
						<th>地市</th>
						<th>测量时间</th>
				...
				<div class="paging_div" id="fasListPageDiv"
					style="border: 1px solid #ddd">
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						条记录
					</span> <a class="paging_link page-first" title="首页"
						onclick="showListViewByPage('first',queryFasDescData,'searchFasForm','fasListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryFasDescData,'searchFasForm','fasListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryFasDescData,'searchFasForm','fasListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryFasDescData,'searchFasForm','fasListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryFasDescData,'searchFasForm','fasListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
