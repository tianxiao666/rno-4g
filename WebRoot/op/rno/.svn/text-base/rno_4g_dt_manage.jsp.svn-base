...
<script type="text/javascript" src="js/rno_4g_dt_manage.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：路测分析 > 路测数据管理 </h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">路测数据导入</a></li>
			<li><a href="#tabs-2">路测数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										--%>
										<tr>
											<td class="menuTd">路测数据文件<span class="txt-impt">*</span>
											</td>
				...
				<table>
					<tr>
						...
						<td><input type="text" value="" id="mrMeaBegDate"
							name="attachParams['dtMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="mrMeaEndDate" name="attachParams['dtMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchMrBtn" value="查询DT"></input></td>
					</tr>
				</table>
