...
<script type="text/javascript" src="js/rno_structure_ncs_analysis.js?v=<%=(String)session.getAttribute("version")%>"></script>
  ...
  <input type="hidden" id="ncsIds" value="<s:property value="#session.NCSTASKINFO.ncsInfo.ncsIds"/>"/>
  	<a href="initNcsAnalysisPageAction" style="text-decoration: underline;font-weight: bold;">&lt;&lt;返回任务列表</a><br>
  	 <font style="font-weight: bold;">任务信息>><font style="color: #31FF81;">Ncs文件选择</font>>>Mrr文件选择>>提交任务</font>
  	<br>
  		
    <div style="width: 100%;margin-top: 20px" id="selectNcsDataDiv">
    <table style="width:600px;margin: 0px auto;">
    <tr><td style="width: 149px; ">选择NCS数据</td><td><input type="button" id="ncsInfoPreStep" name="" value="<上一步 "/></td><td><input type="button" id="ncsInfoNextStep" name="" value="下一步 >"/></td></tr>
    </table>
    </div>
									...
									<tr>
										<td style="width: 20%">
											<p>
												...
												<input type="button" id="ncsConfirmSel"
													value="确定选择" />
											</p>
										</td>
									</tr>
