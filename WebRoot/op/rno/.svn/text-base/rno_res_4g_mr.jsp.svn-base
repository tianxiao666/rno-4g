...
<script type="text/javascript" src="js/rno_res_4g_mr.js"></script>
<script
...
<body>
<body>
	<span class='navTitle'><h2>当前位置：PCI优化 > MR测量数据管理</h2></span>
	...
	<div id="tabs">
		<ul>
			<li><a href="#tabs-1">MR数据导入</a></li>
			<li><a href="#tabs-2">MR数据查询 </a></li>
		</ul>
		<div id="tabs-1">
			<div id="listinfoDiv">
					<form id="searchImportForm">
						...
						<div id="searchImportDiv" style="height:153px;background:url('images/ui-bg_glass_65_ffffff_1x400.png') repeat-x scroll 50% 50% #ffffff;border:1px solid #fbd850">
							...
							<input type="hidden" name="fileCode" id='fileCode'
								value="ERI4GMRFILE" /> <input type="hidden"
					...
					<div id="importDiv" class="importContent">
						<form id="formImportMr" enctype="multipart/form-data"
							method="post">
							<input type="hidden" name="fileCode" id='fileCode'
							...
							<div>
								<table class="main-table1 half-width"
									...
									<tbody>
										...
										<tr>
											<td class="menuTd">MR测量文件<span class="txt-impt">*</span>
											</td>
										...
										<tr>
											...
											<select id="factory"
										name="">
											<option value='ZTE4GMRFILE'>中兴</option>
											<option value='ERI4GMRFILE'>爱立信</option>
											</select>
												</td>
										</tr>
									</tbody>
				...
				<div id="importListDiv" class="sectionDivCls">
					...
					<div class="paging_div" id="mrImportRecPageDiv"
						style="border: 1px solid #ddd">
						<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
							条记录
						</span> <a class="paging_link page-first" title="首页"
							onclick="showListViewByPage('first',queryImportDataRec,'searchImportForm','mrImportRecPageDiv')"></a>
						<a class="paging_link page-prev" title="上一页"
							onclick="showListViewByPage('back',queryImportDataRec,'searchImportForm','mrImportRecPageDiv')"></a>
						...
						<a class="paging_link page-go" title="GO"
							onclick="showListViewByPage('num',queryImportDataRec,'searchImportForm','mrImportRecPageDiv')">GO</a>
						<a class="paging_link page-next" title="下一页"
							onclick="showListViewByPage('next',queryImportDataRec,'searchImportForm','mrImportRecPageDiv')"></a>
						<a class="paging_link page-last" title="末页"
							onclick="showListViewByPage('last',queryImportDataRec,'searchImportForm','mrImportRecPageDiv')"></a>
					</div>
				</div>
			</div>
			<%--某项job的报告 --%>
			...
			<form id="searchMrForm">
				...
				<table>
					<tr>
						...
						<td><input type="text" value="" id="mrMeaBegDate"
							name="attachParams['mrMeaBegDate']" style="width:135px" /></td>
						<td>至：</td>
						<td><input type="text"
							value="<s:date name="todaytime" format="yyyy-MM-dd" />"
							id="mrMeaEndDate" name="attachParams['mrMeaEndDate']"
							style="width:135px" /></td>
						<td  style="padding-left:10px"><input type="button" id="searchMrBtn" value="查询MR"></input></td>
					</tr>
				</table>

			</form>
			<div id="ncsListDiv" class="sectionDivCls">
				<table id="mrListTab" class="greystyle-standard"
					style="width:auto;margin-left:0">
					<thead>
						<th>地市</th>
						<th>测量时间</th>
				...
				<div class="paging_div" id="mrListPageDiv"
					style="border: 1px solid #ddd">
					<span class="mr10">共 <em id="emTotalCnt" class="blue">0</em>
						条记录
					</span> <a class="paging_link page-first" title="首页"
						onclick="showListViewByPage('first',queryMrDescData,'searchMrForm','mrListPageDiv')"></a>
					<a class="paging_link page-prev" title="上一页"
						onclick="showListViewByPage('back',queryMrDescData,'searchMrForm','mrListPageDiv')"></a>
					第 <input type="text" id="showCurrentPage" class="paging_input_text"
						value="0" /> 页/<em id="emTotalPageCnt">0</em>页 <a
						class="paging_link page-go" title="GO"
						onclick="showListViewByPage('num',queryMrDescData,'searchMrForm','mrListPageDiv')">GO</a>
					<a class="paging_link page-next" title="下一页"
						onclick="showListViewByPage('next',queryMrDescData,'searchMrForm','mrListPageDiv')"></a>
					<a class="paging_link page-last" title="末页"
						onclick="showListViewByPage('last',queryMrDescData,'searchMrForm','mrListPageDiv')"></a>
				</div>
			</div>
		</div>
	</div>
