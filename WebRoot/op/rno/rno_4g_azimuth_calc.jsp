...
.taskInfoTab td {
  ...
  <body>
	...
	<font style="font-weight: bold;">当前位置： PCI优化 > LTE网络覆盖分析</font>
	<br>
			...
			<div style="width: 80%;margin-left: 6%;padding-top: 10px">
				<table width="50%">
					<tbody>
						<tr>
							<td style="width: 5%">
								<p><font style="font-weight: bold">LTE网络覆盖分析任务列表</font></p>
							</td>
							<td style="width: 15%">
	...
	<%-- ============================================弹出1 窗口开始=================================================== --%>
								...
								<div id="azimuth_calcWinDiv" class="dialog2 draggable"
									...
									<div class="dialog_header">
										<div class="dialog_title">创建LTE网络覆盖分析任务</div>
