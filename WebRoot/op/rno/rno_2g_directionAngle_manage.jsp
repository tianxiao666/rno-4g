...
<script type="text/javascript" src="js/rno_2g_directionAngle_manage.js?v=<%=(String)session.getAttribute("version")%>"></script>
  ...
  <body>
	...
	<div style="width: 80%;margin-left: 6%;padding-top: 10px">
		<table width="50%">
			<tbody>
				<tr>
					<td style="width: 5%">
						<p><font style="font-weight: bold">任务列表</font></p>
					</td>
					<td style="width: 20%">
	...
	<div style="width: 80%;margin-left: 6%;padding-top: 10px">
		...
		<form id='downloadDirAngleFileForm' action='downloadDirAngleFileAction' method='post' style="display:none">
