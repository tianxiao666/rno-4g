...
<script type="text/javascript" src="js/rno_4g_interfer_martix_manage.js?v=<%=(String)session.getAttribute("version")%>"></script>
	...
	<div style="width: 80%;margin-left: 6%;padding-top: 10px">
		<table width="50%">
			<tbody>
				<tr>
					<td style="width: 5%">
						<p><font style="font-weight: bold">LTE干扰矩阵列表</font></p>
					</td>
					<td style="width: 2%;">
	...
	<div style="width: 80%;margin-left: 6%;padding-top: 10px">
		<table id="interferMartixTable" class="greystyle-standard" width="80%">
			<tr>
				...
				<th style="width: 8%">使用的MR测量时间</th>
				<th style="width: 8%">数据量</th>
				<th style="width: 8%">类型</th>
				<th style="width: 8%">状态</th>
			</tr>
		</table>
		<form id='download4GMatrixFileForm' action='download4GMatrixFileAction' method='post' style="display:none">
